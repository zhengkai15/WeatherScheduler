...
# nohup bash ./forecast/autorun.sh > inference.log 2>&1 &
...
#            break
    ...
    if [ $flag -eq 1 ]; then
        ...
        python ./forecast/main.py --init_time ${V_DAY}  --model  ./FuXi_EC/onnx_c92/ --input_save_dir ./FuXi_EC/input_onnx_c92 --save_dir ./FuXi_EC/output_onnx_c92 --init_time_type case4  --raw_data_format_type grib &&
        ...
        python ./forecast/main.py --init_time ${date_now} --model  ./FuXi_EC/onnx_c92/ --input_save_dir ./FuXi_EC/input_onnx_c92 --save_dir ./FuXi_EC/output_onnx_c92 --init_time_type case2 --raw_data_format_type grib &&
        echo "${date_now} 12 inference done"
        echo "submit ${date_now} 12 data to oss"
        # submit data to oss
        python ./forecast/submit2oss.py  --prefix inference_output_onnx_c92 --filename ./FuXi_EC/output_onnx_c92/$date_now-12_input_grib-output/ &&
