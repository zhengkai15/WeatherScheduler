...
parser.add_argument('--model', type=str, required=False, default=f'{flag}/model/', help="onnx model dir")
...
parser.add_argument('--device', type=str, default="cuda", help="The device to run model")
...
if __name__ == "__main__":
    ...
    for stage in stages:
        ...
        if os.path.exists(model_path):
            ...
            models[stage] = model
            print(f'Load {stage} take {time.perf_counter() - start:.2f} sec')
